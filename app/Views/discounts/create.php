...
<?= $this->section('title'); ?>Create Discount<?= $this->endSection(); ?>

<?= $this->section('content'); ?>
<div class="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">

    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900">Create Discount</h1>
        <a href="<?= base_url('discounts'); ?>" class="rounded bg-gray-100 px-4 py-2 text-gray-700 hover:bg-gray-200">← Back</a>
    </div>

    <div class="rounded-lg border border-gray-200 bg-white p-6">
        <form method="post" action="<?= base_url('discounts/store'); ?>" class="space-y-4">
