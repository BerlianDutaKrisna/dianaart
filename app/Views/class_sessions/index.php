...
<div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900">Class Sessions</h1>
        <a href="<?= base_url('class-sessions/create'); ?>" class="rounded bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-500">+ Create</a>
    </div>
                ...
                <?php if (!empty($class_sessions)): ?>
                    <?php foreach ($class_sessions as $s): ?>
                        <tr class="text-sm text-gray-700">
                            ...
                            <td class="px-4 py-3">
                                <a href="<?= base_url('class-sessions/show/' . $s['id']); ?>" class="font-medium text-indigo-600 hover:underline">
                                    <?= esc($s['name']); ?>
                                </a>
                            </td>
                            ...
                            <td class="px-4 py-3 space-x-2">
                                <a href="<?= base_url('class-sessions/edit/' . $s['id']); ?>" class="text-indigo-600 hover:underline">Edit</a>
